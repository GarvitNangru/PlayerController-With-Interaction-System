...
namespace PlayerController
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        {
            if ((movementInputData.CrouchClicked || movementInputData.IsCrouching) && m_isGrounded)
                InvokeCrouchRoutine();
        }
        ...
        protected virtual void InvokeCrouchRoutine()
        {
            ...
            if (movementInputData.CrouchClicked && movementInputData.IsCrouching)
                return;
        ...
        protected virtual void HandleRunFOV()
        {
            ...
            if (movementInputData.IsRunning || !movementInputData.HasInput || m_hitWall)
            {
        ...
        protected virtual void HandleJump()
        {
            if (movementInputData.JumpClicked && !movementInputData.IsCrouching)
            {
                ...
                m_previouslyGrounded = true;
                m_isGrounded = false;
                movementInputData.JumpClicked = false; // set jump clicked to false 
            }
        }
